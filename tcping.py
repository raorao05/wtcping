...
if __name__ == '__main__':
    print "====================================================\r"
    print " the program accecpt input ,domain:port,such as \n"
    print " example_1  www.baidu.com:80 "
    print " example_2  www.google.com:443"
    print "====================================================\n\r\n\r"
    while 1:
       
        userInput = raw_input("please input , then press Enter: \n")
        try:
            userInput = userInput.split(':')
            if userInput:
                host = userInput[0].strip(' ')
                try:
                    port = userInput[1].strip(' ')
                except:
                    port = 80        
                cli(host,port,8,3,1)
        except:
            pass
            # print "please input right command, like 'www.baidu.com'"
        #cli(userInput,80,4,3,False)
